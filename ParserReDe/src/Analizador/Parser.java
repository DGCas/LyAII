...
public class Parser {
	...
	void Declarations () throws UnexpectedTokenException{
		Avanza();
		//Verifica que tipo de token es el que se utiliza, si no se sale del mï¿½todo.
		if(tokenCode == Int || tokenCode == Float){
			...
			//Come(Id);
			//Agrega a la lista de declaraciones una nueva declaraciï¿½n.
	...
	//Mï¿½todo para la creacion y verificacion de los estatutos, regresa un estatuto.
...
//Crea un objeto de tipo expresion, al llamar al metodo para crear la expresion.
	...
	//Mï¿½todo para realizar la parte de la expression de igualdad.
